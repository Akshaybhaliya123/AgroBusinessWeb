...
<body>
  <div class="row">
    ...
    <div class="uppart">
      ...
      <center>  <h3>FOOTER DATABASE</h3><center>
        <hr id="righthr">
        <form action="footersearch.php" method="GET">
...
while($res= mysqli_fetch_assoc($data)){
    ...
    <td><button class='databtn'><a href='editfooter.php?edi=".$res['id']."'>EDIT</a></button></td>
    <td><button onclick='return confirm(\"Are You sure you want to delete this data ??\")' class='databtn'><a href='deletefooter.php?del=".$res['id']."'>DELETE</a></button></td>
    </tr>
    ";
}
