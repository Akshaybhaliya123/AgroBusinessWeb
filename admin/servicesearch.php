...
<body>
  <div class="row">
    ...
    <div class="uppart">
      ...
      <center>  <h3>SERVICE DATABASE</h3><center>
        <hr id="righthr">
        <form action="servicesearch.php" method="GET">
...
<?php
$search = $_GET['search'];
$query = "SELECT * FROM servicedata WHERE userName='$search'";
...
while($res= mysqli_fetch_assoc($data)){
    ...
    <td>".$res['Statuss']."</td>
    <td><button class='databtn'><a href='editservice.php?edi=".$res['id']."'>EDIT</a></button></td>
    <td><button onclick='return confirm(\"Are You sure you want to delete this data ??\")' class='databtn'><a href='deleteservice.php?del=".$res['id']."'>DELETE</a></button></td>
    </tr>
    ";
}
?>
