...
<body>
  <div class="row">
    ...
    <div class="uppart">
      ...
      <center>  <h3>CONTACT DATABASE</h3><center>
        <hr id="righthr">
        <form action="contactsearch.php" method="GET">
...
<?php
$search = $_GET['search'];
$query = "SELECT * FROM contact WHERE username='$search'";
...
while($res= mysqli_fetch_assoc($data)){
    ...
    <td>".$res['username']."</td>
    <td>".$res['Email']."</td>
    <td>".$res['usermessage']."</td>
    <td>".$res['DateandTime']."</td>
    <td>".$res['Statuss']."</td>
    <td><button class='databtn'><a href='editcontact.php?edi=".$res['id']."'>EDIT</a></button></td>
    <td><button onclick='return confirm(\"Are You sure you want to delete this data ??\")' class='databtn'><a href='deletecontact.php?del=".$res['id']."'>DELETE</a></button></td>
    </tr>
    ";
}
